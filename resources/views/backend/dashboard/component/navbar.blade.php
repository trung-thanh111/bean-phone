        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle"
                    src="/backend/img/{{ Auth::user()->image ?? 'avt-conan.jpg' }}">
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown"><a
                    ...
                    <i class="fa-solid fa-key mr-2 text-secondary"></i>
                    Đổi mật khẩu
                </a>
                <a class="dropdown-item" href="{{ route('home.index') }}">
                    <i class="fa-solid fa-user-tie mr-2 text-secondary"></i>
                    Trang chủ
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#"
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="fas fa-sign-out-alt fa-sm mr-2 text-secondary"></i>
                    Đăng Xuất
                </a>
