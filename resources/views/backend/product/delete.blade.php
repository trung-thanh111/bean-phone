<div class="wrapper p-2">
    ...
    <div class="row pr-4 pl-4 mt-3">
        <div class="col-md-6">
            ...
            <div class="fz-14">
                <p class="mb-1">Bạn hãy chắc chắn muốn xóa thông tin sản phẩm <strong class="text-danger">id =
                        {{ $product->id }}</strong>.</p>
        ...
        <div class="col-md-6">
            <form action="{{ route('product.destroy', ['id' => $product->id]) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{ $product->title }}" readonly>
                </div>
