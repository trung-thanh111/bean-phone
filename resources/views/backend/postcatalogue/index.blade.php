<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800 font-weight-bold text-uppercase">Nhóm bài viết</h1>
    ...
    <div class="parent-container mb-3" style="text-align: right;">
        <div class="create btn btn-success pt-2 pb-2 ps-3 pe-3 rounded-0">
            ...
            <a href="{{ route('post.catalogue.create') }}" class="fz-18 text-decoration-none text-white font-weight-bold">
                Thêm mới
            </a>
        </div>
    </div>
    <div class="parent-container mb-3 d-flex justify-content-end" style="text-align: right;">
        <div style="margin-right: 15px">
            <form action="{{ route('admin.post.catalogues') }}" method="get">
                @csrf
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Danh sách nhóm bài viết</h6>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($postCatalogues as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="img" style="margin-right: 10px">
                                            <img src="/upload/post/{{ $item->image }}" alt="" class="object-fit-cover"
                                            width="100" height="70">
                                        </div>
                                        <div class="info">
                                ...
                                <td class="text-center">{{ ($item->order > 0) ? $item->order : 'Chưa sắp xếp'  }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-around border-0">
                                        <div class="update" style="font-size: 25px">
                                            <a href="{{ route('post.catalogue.update', ['id' => $item->id]) }}">
                                                <i class="fa-solid fa-pen-to-square text-primary"></i>
                                            </a>
                                        </div>
                                        <div class="trash" style="font-size: 25px">
                                            <a href="{{ route('post.catalogue.delete', ['id' => $item->id]) }}">
                ...
                <div class="d-flex justify-content-end mt-5">
                    {{ $postCatalogues->onEachSide(3)->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
