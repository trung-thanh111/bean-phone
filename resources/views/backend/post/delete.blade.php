<div class="wrapper p-2">
    <div class="title-create pl-4 pb-4">
        <h4 class="font-weight-bold text-uppercase mb-3">xóa Bài viết</h4>
    ...
    <div class="row pr-4 pl-4 mt-3">
        <div class="col-md-6">
            ...
            <div class="fz-14">
                <p class="mb-1">Bạn hãy chắc chắn muốn xóa thông tin Bài viết <strong class="text-danger">id =
                        {{ $post->id }}</strong>.</p>
                <p>Sau khi xóa thông tin Bài viết sẽ không thể phục hồi!</p>
            </div>
        </div>
        <div class="col-md-6">
            <form action="{{ route('post.destroy', ['id' => $post->id]) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control rounded-0" value="{{ $post->title }}" readonly>
                </div>
