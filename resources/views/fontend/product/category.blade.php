            ...
            <ol class="breadcrumb container">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    @php
                        $printed = false;
                    @endphp
                    @foreach ($productInCategories as $key => $item)
...
<div class="container mb-5  ">
    <div class="row mt-4">
        <div class="col-4">
            <img src="/fontend/img/img_3banner_1.webp" class="rounded-2 me-2 w-100" alt="">
        </div>
        <div class="col-4">
            <img src="/fontend/img/img_3banner_2.webp" class="rounded-2 me-2 w-100" alt="">
        </div>
        <div class="col-4">
            <img src="/fontend/img/img_3banner_3.webp" class="rounded-2 me-2 w-100" alt="">
        </div>
    </div>
    <div class="row">
        <div class="col">
        ...
        <div class="col-9">
            <div class="d-flex justify-content-between">
                <h1 style="font-size: 18px; font-weight: bold;"
                    class="mb-2 mt-2 rounded-2 bg-light pt-1 pb-1 ps-1 text-uppercase">
                    Sản Phẩm
                    @php
                        $printed = false;
                    @endphp
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-end mt-5">
                    {{ $productInCategories->onEachSide(3)->links('pagination::bootstrap-5') }}
